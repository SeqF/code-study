...
public class Client {
    ...
    *
    *    BeanFactory:  多例对象适用
    *         它在构建核心容器时，创建对象采取的策略是延迟加载的方式，也就是说什么时候根据id获取对象了，什么时候才真正的创建对象(用的时候才创建)
    *
    * */
    public static void main(String[] args) {
//        //1.获取Spring的上下文对象
//        ApplicationContext ac= new ClassPathXmlApplicationContext("bean.xml");
//        //2.我们的对象现在都在Spring中被管理，我们要使用，就直接去里面取出来
//        IAccountService as = (IAccountService)ac.getBean("accountService");//第一种方式，直接强转
//        IAccountDao adao = ac.getBean("accountDao",IAccountDao.class);//第二种方式，传入字节码来强转
//
